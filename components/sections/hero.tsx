        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="relative mt-10 lg:mt-0 flex justify-center">
            ...
            <div className="relative w-full ">
              ...
              <div className="absolute -left-6 top-10 z-20 animate-bounce-slow">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white shadow-2xl p-1">
               ...
               <div className="absolute -right-12 top-1/3 z-20 animate-pulse-slow">
                 <div className="rounded-2xl bg-white p-4 shadow-xl flex items-center gap-3">
                    <div className="h-10 w-10 overflow-hidden rounded-full bg-yellow-400 border-2 border-white shadow-sm">
                       <Image src="/logo.png" alt="Avatar" width={40} height={40} className="object-cover" />
                     </div>
                     <div>
                       <p className="text-xs font-bold text-slate-900">Savannah Nguyen</p>
